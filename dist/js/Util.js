...
export const createTimeField = (value, className, onchange = null) => {
    const field = h('input', { class: 'form-time ' + className, value, type: 'text' });
...
export const createTextField = (value, placeholder = '', className, onchange = null, oninput = null) => {
    const field = h('input', { class: 'form-text ' + className, value, type: 'text', placeholder });
...
export const createMultilineTextField = (value, placeholder = '', className, onchange = null) => {
    const field = h('textarea', { class: 'form-text-multiline fs-flex' }, value);
    if (onchange !== null)
        field.addEventListener('change', onchange);
    return field;
};
export const createCheckbox = (checked, className, onchange = null) => {
    const checkbox = h('input', { class: 'form-checkbox ' + className, type: 'checkbox' });
...
export const createRadio = (checked, name, className, onchange = null) => {
    const radio = h('input', { class: 'form-radio ' + className, type: 'radio', name });
