...
export default class Sidebar {
  ...
  public show() {
    ...
    const logo = h('div', { id: 'header-logo' }, null, () =>
      this.app.showStartView()
    );
    const file = h('div', { id: 'sidebar-outbound' }, null, () =>
      this.app.showFileSettingView(0)
    );
    ...
    const outbound = h('div', { id: 'sidebar-outbound' }, null, () =>
      this.app.showTrainTimetableView(null, 0)
    );
    ...
    const diagram = h('div', { id: 'sidebar-diagram' }, null, () =>
      this.app.showDiagramView(null)
    );
