...
import { h, createTextField, createCheckbox, createRadio, createButton } from '../Util.js';
import { Station } from '../DiagramParser.js';
export default class StationSettingView extends View {
  svgElement: Element;
  hoverElement: SVGGElement;
  rowHeight: number;
  insertButton: SVGGElement;
        ...
        h('div', { class: 'fs-track-grid' }, [
          ...
          ...station.tracks.map((track, i) => {
            ...
            fragment.append(...[
              ...
              createTextField(track.abbrName[0], '',  '', e => track.abbrName[0] = (e.currentTarget as HTMLInputElement).value),
  ...
  private updateRailmap() {
    ...
    for (let i = 0; i < stations.length; i++) {
      ...
      if (stations[i].brunchCoreStationIndex !== null) {
        ...
        content.push(
          ...
          }, '(' + stations[i].name + ')', null, 'http://www.w3.org/2000/svg'),
          h('circle', {
            cx: 44,
            cy: y + 16,
            r: 4,
    ...
    this.insertButton = h('g', { class: 'fs-railmap-insert' }, [
      h('line', { x1: 0, y1: 0.5, x2: 300, y2: 0, 'stroke-dasharray': '2 1' }, null, null, 'http://www.w3.org/2000/svg'),
    ...
    ], null, 'http://www.w3.org/2000/svg') as SVGGElement;
